...
_UNIVERSAL_ENCODINGS: Final[frozenset[str]] = frozenset(
    {"utf-8", "utf8", "utf-16", "utf16", "utf-32", "utf32"}
)
...
def echo(
    message: object = "", *, file: IO[Any] | None = None, err: bool = False, nl: bool = True
) -> None:
